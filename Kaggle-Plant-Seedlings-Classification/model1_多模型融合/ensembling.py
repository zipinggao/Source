...
model_inceptionv3.load_weights('params/inceptionV3/weights_inceptionV3_1_31.h5')
...
models = [model_xception, model_inceptionresnetv2]  #model_inceptionv3
...
test_df['file'] = generator.filenames
test_df['species'] = preds
