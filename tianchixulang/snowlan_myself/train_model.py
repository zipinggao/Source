...
class Model(object):
     ...
     def train(self,train_file,verification_file):
        ...
        '''
         ...
         '''
         self.model.fit_generator(aug.flow(trainx,trainy,self.BatchSize), steps_per_epoch=1500,
        ...
        '''
         ...
         self.model.fit(trainx,trainy,validation_data =(testx,texty),shuffle= True ,epochs = self.Epochs,batch_size = self.BatchSize,callbacks=callbacks_list)
